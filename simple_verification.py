...
def test_typography_css_content():
    """测试typography.css文件内容"""
    css_path = '/Users/jingcheng407/git/hcc/dolch_sight_word_list/static/css/typography.css'
    ...
    try:
        ...
        print(f"❌ 读取typography.css时出错: {e}")
        return False

def test_html_css_references():
    """测试HTML文件中的CSS引用"""
    html_path = '/Users/jingcheng407/git/hcc/dolch_sight_word_list/templates/index.html'
    
    try:
        with open(html_path, 'r', encoding='utf-8') as f:
            html_content = f.read()
        
        # 检查是否包含typography.css引用
...
def main():
    ...
    tests = [
        ...
        ("Typography.css内容检查", test_typography_css_content),
        ("HTML CSS引用检查", test_html_css_references),
